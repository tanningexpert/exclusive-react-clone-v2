...
const VaginalRejuvenation = () => {
  ...
  return (
    <>
      ...
      <div className="aestheticsPageWrapper">
        <div className="aestheticsPageBody">
          <p>
            Introducing Vaginal Rejuvenation, the innovative non-surgical
            approach to to vaginal tightening and reversing vaginal dryness.
            Whether you've recently gone through pregnancy or simply want to
            feel rejuvenated, this non-surgical approach is a safe, easy way to
            gain back control of your body.
            <br />
            With Vaginal Rejuvenation, you can enjoy restored vaginal tightness
            and less vaginal dryness and pain during sex. And it's not just
            about intimacy - Vaginal Rejuvenation also helps stop bladder leaks
            so you feel more confident in your day-to-day activities.
          ...
          <h2 className="pageSubTitle">
            What does vaginal rejuventaion treat?{" "}
          </h2>
          ...
          <li>
            Many patients notice significant improvements within 1 to 2 days
            after treatment
          </li>
          ...
          <p>
            ...
            This gentle procedure uses radiofrequency energy to tighten tissue
            and stimulate the production of collagen. Through this uniform RF
            heating, Votiva achieves the desired stimulation of elastin and
            collagen production and an increase in blood flow. When those three
            parameters are stimulated, the result is increased vaginal
            lubrication and elasticity, elimination of urinary incontinence, and
          ...
          <p>
            ...
            annual gynecological exam when the probe is inserted into the
            vagina.
          </p>
          <ul>
            <li>
              First, ultrasound gel is applied to the head of the FormaV wand
          ...
          <p>
            ...
            reported side effects from some patients are that they may see
            slight redness in the treated area, which will subside within a few
            hours. It is advisable that patients wait approximately 1 week
            before having intercourse to allow for optimal healing.
          </p>
          <h2 className="pageSubTitle">Is Votiva safe? </h2>
          <p>
            The FormaV applicator is the only device that monitors the vaginal
            lining temperatures and cuts off the temperature and sustains the
            end point automatically during the treatment, preventing
            over-heating and burns, but also ensuring the best possible
            tightening .The sustained, gentle, non-painful heat results in
            remodeling of the vaginal mucosa and sub-mucosal tissues with
            increased tightening and mucosal secretions.
          </p>
          ...
          <p>
            ...
            satisfaction during intercourse. You may want to consider that
            Votiva procedure if your vagina and the surrounding muscles have
            altered and stretched due to aging, pregnancy, or weight loss.
          ...
          <p>
            ...
            rejuvenation and it is safe and effective for feminine concerns
            like:
            <ul>
              ...
              <li>
                Wrinkled appearance and loss of elasticity of the vulva and
                labia
              </li>
            </ul>
        ...
        <div className="procedureWrapper">
          <ProcedureContainer
            treatmentCost={vaginalRejuvenation.price}
            treatmentLength={vaginalRejuvenation.length}
            treatmentSchedule={vaginalRejuvenation.pageSchedule}
            downtime={vaginalRejuvenation.downtime}
          />
        </div>
      </div>
    </>
